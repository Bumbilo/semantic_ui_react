...
const UserAll = () => (
    <Popup trigger={<a className="count_users">+2 more</a>} on='click' className="popup_users" position='bottom center'>
        <Popup.Content>
            <UserPopupMinsy/>
            <UserPopupJohn/>
            <UserPopupDen/>
            ...
            <UserPopupJohn/>
            <UserPopupDen/>
            <ul className="popup_users_paginator">
                <li> <Icon name="chevron left"/> </li>
                <li className="active_li">1</li>
                <li>2</li>
                <li>3</li>
                <li>4</li>
                <li>...</li>
                <li>11</li>
                <li> <Icon name="chevron right"/> </li>
            </ul>
        </Popup.Content>
    </Popup>
);
...
class EmployeeSettingsUser extends React.Component {
    render() {
        return (<Employees/>);
    }
}
