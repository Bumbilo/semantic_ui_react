...
const InformationBlock = () => (
    <div className="employee_dushboard_setup yellow">
       <Grid>
          <Grid.Row>
             <Grid.Column width={2}>
               <Image src={nottes}/> 
             ...
             <Grid.Column width={3} textAlign="center">
               <Button className="circular_btn inherit">1</Button>
               <p> Lorem ipsum dolor sit, consectetur adipisicing elit</p>
               <Button basic className="yellow_btn">Add employees</Button>
             </Grid.Column>
             <Grid.Column width={3} textAlign="center">
            <Button className="circular_btn inherit">2</Button>
                <p> Lorem ipsum dolor sit, consectetur adipisicing elit</p>
                 <Button basic className="yellow_btn">Add Departments</Button>
             </Grid.Column>
             <Grid.Column width={3} textAlign="center">
                <Button className="circular_btn inherit">3</Button>
                <p> Lorem ipsum dolor sit, consectetur adipisicing elit</p>
               <Button basic className="yellow_btn">Add Position</Button>
             </Grid.Column>
          </Grid.Row>
       </Grid>
        <Icon name='close'/>
...
class DashboardSetupGuide2 extends React.Component {
    render() {
        return (<Employees/>);
    }
}
