...
const UserAll = () => (
    <Popup trigger={<a className="count_users">+2 more</a>} on='click' className="popup_users user" position='bottom center'>
        <Popup.Content>
            <UserPopupMinsy/>
            <UserPopupJohn/>
            <UserPopupDen/>
...
class EmployeeSettingsUser2 extends React.Component {
    render() {
        return (<Employees/>);
    }
}
