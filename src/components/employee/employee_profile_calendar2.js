...
const PopupHoliday1 = () => (
    <Popup
        trigger={<span style={HolidayProgress}></span>} position='bottom center'>
...
const PopupHoliday2 = () => (
    <Popup
        trigger={<span style={HolidayProgress2}/>} position='bottom center'>
        <div className="popup_content">
            <div className="popup_title">
                Holiday
            </div>
...
const PopupHoliday3 = () => (
    <Popup
        trigger={<span style={HolidayProgress3}/>} position='bottom center'>
        <div className="popup_content">
            <div className="popup_title">
                Holiday
            </div>
...
const PopupHoliday4 = () => (
    <Popup
        trigger={<span style={HolidayProgress4}/>} position='bottom center'>
        <div className="popup_content">
            <div className="popup_title">
                Holiday
            </div>
...
const PopupHoliday5 = () => (
    <Popup
        trigger={<span style={HolidayProgress5}/>} position='bottom center'>
        <div className="popup_content">
            <div className="popup_title">
                Holiday
            </div>
...
const SidebarblockPopup = () => (
    <Popup
        trigger={
            <div className="sidebar_block-item">
               <Grid>
                  <Grid.Row columns={2}>
                     <Grid.Column>
                        <Icon name="plane"/>
                     ...
                     <Grid.Column>
                        <div className="sidebar_block-days">
                           <span className="sidebar_days_count">28</span>
                           <span className="sidebar_days_title">days</span>
                        </div>
                     </Grid.Column>
                  </Grid.Row>
                  <div className="sidebar_block-footer">Annual Entitlement</div>
               </Grid>
            </div>
        } position='top center' size="mini">
        <div className="popup_content">
        <span className="sidebar_popup">
            ...
            <div className="sidebar_block-item">
               <Grid>
                  <Grid.Row columns={2}>
                     ...
                     <Grid.Column>
                        <div className="sidebar_block-days">
                           <span className="sidebar_days_count">19 	&#189;</span>
                           <span className="sidebar_days_title">days</span>
                        </div>
                     </Grid.Column>
                  </Grid.Row>
                  <div className="sidebar_block-footer">Booked</div>
               </Grid>
            </div>
        } position='top center' size="mini">
        <div className="popup_content">
            ...
            <div className="sidebar_block-item">
               <Grid>
                  <Grid.Row columns={2}>
                     ...
                     <Grid.Column>
                        <div className="sidebar_block-days">
                           <span className="sidebar_days_count">10</span>
                           <span className="sidebar_days_title">days</span>
                        </div>
                     </Grid.Column>
                  </Grid.Row>
                  <div className="sidebar_block-footer">Current account balance</div>
               </Grid>
            </div>
        } position='top center' size="mini">
        <div className="popup_content">
            ...
            <div className="sidebar_block-item">
               <Grid>
                  <Grid.Row columns={2}>
                     ...
                     <Grid.Column>
                        <div className="sidebar_block-days">
                           <span className="sidebar_days_count">8 &#189;</span>
                           <span className="sidebar_days_title">days</span>
                        </div>
                     </Grid.Column>
                  </Grid.Row>
                  <div className="sidebar_block-footer">Remaining</div>
               </Grid>
            </div>
        } position='top center' size="mini">
        <div className="popup_content">
...
const ButtonInfo = () => (
    <Popup
        trigger={<button className="btn_request_item btn_orange"><Icon name='info'/></button>}
        position='top right'
        size='tiny' >
        <div className="popup_content">
          <span className="info_popup">Pending approval</span>
         </div>
    </Popup>
);
...
class EmployeeProfileCalendar2 extends React.Component {
    render() {
        return (<Employees/>);
    }
}
